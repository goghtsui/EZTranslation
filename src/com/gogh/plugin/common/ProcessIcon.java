...
public class ProcessIcon extends AsyncProcessIcon {
    ...
    private static final Icon ICON_PASSIVE = IconLoader.getIcon("/process/fs/step_passive@2x.png");

    public ProcessIcon() {
        super("Querying Process");
    }
}
