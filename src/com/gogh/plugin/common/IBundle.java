...
public class IBundle extends AbstractBundle {

    public static final String PATH_TO_BUNDLE = "i18n.TranslationBundle";

    private static final IBundle BUNDLE = new IBundle();
    ...
    public static String message2(@NotNull @PropertyKey(resourceBundle = PATH_TO_BUNDLE) String key
            , @NotNull Object... params) {
