...
//				applyFontSize();
    ...
    private class MyShowSettingsButton extends ActionButton {
        private MyShowSettingsButton() {
            this(new MyShowSettingsAction(), new Presentation(), IString.TRANSLATION_INPLACE_SETTINGS
    ...
    private class ExternalTranslationAction extends AnAction implements HintManagerImpl.ActionToIgnore {
        ...
        public void actionPerformed(AnActionEvent e) {
            ...
            com.gogh.plugin.action.ExternalTranslationAction.showExternalTranslation(myQuery
                    , myTranslator.getExternalUrl(myQuery), e.getDataContext());
        }
...
//				applyFontSize();
    ...
    private void registerActions() {
        myExternalTranslationAction.registerCustomShortcutSet(ActionManager.getInstance()
                .getAction(IString.ACTION_EXTERNAL_TRANSLATION).getShortcutSet(), myEditorPane);
    ...
    // FIXME: 9/7/2016
    public void setDocumentData(String query, String text, ResultEntity entity, final Translator translator) {
        myTranslator = translator;
        ...
        myIsEmpty = false;
        updateControlState();
        setDocumentDataInternal(query, text, entity, new Rectangle(0, 0));
    }

    private void setDocumentDataInternal(String query, String text, ResultEntity entity, final Rectangle viewRect) {
        setQuery(query);
        //
        BalloonAdapter.insertQueryResultText(myEditorPane.getDocument(), entity);
        //
